...
public class InfoScreen extends Screen
{
    ...
    public void update(float deltaTime)
    {
        ...
        gameEngine.drawText(font, text1, 35, 130, Color.WHITE, 18);
        text2 = "get a higher score" ;
        gameEngine.drawText(font, text2, 78, 150, Color.WHITE, 18);
        text3 = "Pick Up power ups" ;
        gameEngine.drawText(font, text3, 80, 200, Color.WHITE, 18);
        ...
        text4 = "Avoid enemies" ;
        gameEngine.drawText(font, text4, 93, 280, Color.WHITE, 18);
